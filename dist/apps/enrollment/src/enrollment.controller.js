...
let EnrollmentController = class EnrollmentController {
    ...
    async getHistory(studentId) {
        try {
            return await this.enrollmentService.getHistory(studentId);
        }
        catch (e) {
    ...
    async getOfferings(studentId, program, yearLevel) {
        try {
            return await this.enrollmentService.getOfferings(studentId, program, yearLevel);
        }
        catch (e) {
            throw new common_1.HttpException(e.message, common_1.HttpStatus.INTERNAL_SERVER_ERROR);
        }
    ...
    async submit(body) {
        try {
            return await this.enrollmentService.submit(body.studentId, body.classAssignmentIds);
        }
        catch (e) {
    ...
    async getStatus(studentId) {
        try {
            return await this.enrollmentService.getStatus(studentId);
        }
        catch (e) {
            throw new common_1.HttpException(e.message, common_1.HttpStatus.INTERNAL_SERVER_ERROR);
        }
...
], EnrollmentController.prototype, "getHistory", null);
__decorate([
    (0, common_1.Get)('offerings'),
    __param(0, (0, common_1.Query)('studentId')),
    __param(1, (0, common_1.Query)('program')),
    __param(2, (0, common_1.Query)('yearLevel')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, String]),
    __metadata("design:returntype", Promise)
], EnrollmentController.prototype, "getOfferings", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], EnrollmentController.prototype, "submit", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], EnrollmentController.prototype, "getStatus", null);
